...
import br.com.vitrini.service.IVitriniService;
import br.com.vitrini.service.VitriniService;
...
public class ActivityController {
	...
	public static void pushTabCall(ApplicationContextProvider provider, int currentTab) {
		...
		Log.e("stack push", provider.tabCallStack.toString());
	}
	...
	public void setAnnotation(Vitrini vitrini, String text) 
	{
		vitrini.setAnnotation(text);
		vitriniService.setAnnotation(vitrini);
	}
}
