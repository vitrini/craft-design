...
import br.com.vitrini.ReadAssetFileUtils;
...
public class DatabaseManager extends SQLiteOpenHelper
{
	...
	private static final String DB_SCRIPTS_EVENT = "db_scripts/craft_25.sql";
	private static final String DB_SCRIPTS_LOCATIONS_EVENT = "db_scripts/locations_craft2015.sql";
	...
	public static DatabaseManager getInstance() {
		if(dbManager == null) 
		{
			...
			if(!dbManager.dataAlreadyLoaded()) {
				dbManager.createInitialDataForEvent();
				Log.e("CARGA DE DADOS", "CRIADO");
			}
		}
		return dbManager;
	}
